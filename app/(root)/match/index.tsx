...
//     setLoading(true)
//     const gameLevels = await getGameLevels('matching')
...
//     router.push(`/(root)/match/${levelId}`)
//   }
...
//           {/* Thumbnail */}
//           <Image 
//             source={{ uri: item.thumbnail || 'https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?w=400' }} 
...
//               <MaterialCommunityIcons name="puzzle" size={12} color="#5D5FEF" />
//               <Text style={styles.gameTypeText}>Match the Fidels</Text>
//             </View>
...
//               <Text style={styles.playButtonText}>Match</Text>
...
//           <MaterialCommunityIcons name="puzzle" size={60} color="#3F3F5F" />
...
//             <MaterialCommunityIcons name="puzzle" size={40} color="#fff" />
//             <View style={styles.headerText}>
//               <Text style={styles.headerTitle}>Fidel Matching</Text>
//               <Text style={styles.headerSubtitle}>Match fidels with sounds & forms</Text>
//             </View>
//           </View>
//         </LinearGradient>
...
//             <Text style={styles.statNumber}>
//               {levels.filter(l => l.content?.pairs?.length || 0).length}
//             </Text>
//             <Text style={styles.statLabel}>Audio Pairs</Text>
//           </LinearGradient>
//         </View>
...
//             <MaterialCommunityIcons name="puzzle-off" size={80} color="#3F3F5F" />
