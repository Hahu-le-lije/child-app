			...
			levels: {
				level_1: {
					question1: {
						...
						audioUrl: "https://cdn.pixabay.com/download/audio/2022/03/15/audio_3901f0f6f7.mp3?filename=kids-cheerful-piano-112194.mp3",
					},
					question2: {
						sentenceTemplate: "I drink warm ____ in the morning.",
						answer: "milk",
						options: ["milk", "chair", "cloud", "clock"],
						audioUrl: "https://cdn.pixabay.com/download/audio/2023/03/27/audio_0e8e11a177.mp3?filename=light-tune-144935.mp3",
					},
					question3: {
						sentenceTemplate: "The dog likes to run in the ____.",
						answer: "park",
						options: ["park", "book", "sock", "moon"],
						audioUrl: "https://cdn.pixabay.com/download/audio/2022/08/04/audio_6f9f8f5f7a.mp3?filename=happy-kids-112698.mp3",
					},
				},
				level_2: {
					question1: {
